...
def get_recommendations(data: QueryInput):
    results = recommend_assessments(data.query, shl_catalog)
...
# --- HERO SECTION + SEARCH SECTION IN ONE CARD ---
st.markdown("""
    <div class='hero-card'>
...
with st.expander("📊 Run Accuracy Evaluation"):
    ...
    if st.button("Run Evaluation"):
        recall, map_score = evaluate_accuracy(recommend_assessments, queries, ground_truths, shl_catalog)
        st.success(f"📈 Recall@3: {recall:.2f} | MAP@3: {map_score:.2f}")
